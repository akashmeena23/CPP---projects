			  	...
			  	case 1: 
			  	     {
						...
						else if(choice1==3)
						{
			  	     	...
			  	     	{
			  	     		cout<<"Invalid input , shifting to the previos menu"<<endl;
			  		        flights();
					    }
...
class ticket:public registration ,details
{
  public:
		...
		{
			string destination="";
			ofstream outf("records.txt") ;     //is used to create or write information in a file
			 {                                 // in record.txt file data of the flights is being stored
			 	
			 	outf<<"___________XYZ Airlines____________"<<endl;
	    ...
	    void dispBill()
	    {
	    	...
	    	{
	    		if(!ifs)    //file is not there
	    		{
	    			cout<<"File Error!"<<endl;
				}
				
				while(!ifs.eof())    // file is there
				{
					ifs.getline(arr,100);
					cout<<arr<<endl;
...
void mainMenu()
{
    ...
    cout<<"\t                     XYZ Airline\n"<<endl;
	cout<<"\t____________________Main Menu________________"<<endl;
	cout<<"\t_________________________________________________________"<<endl;
	cout<<"\t\t\t\t\t\t\t"<<endl; 
	
	cout<<"\t|\t Press 1 to add the Customer Details    \t|"<<endl;
	cout<<"\t|\t Press 2 for Flight Details             \t|"<<endl;
   ...
   switch(lchoice)
   {
   	case 1: 
   	   {
   		 cout<<"_____________Customers_________________\n"<<endl;
   		 d.information();
   		 cout<<"Press any key to go back to the Main Menu : ";
   		 cin>>back;
	...
	case 2: 
	{
		cout<<"______________Book a Flight using the System ____________\n"<<endl;
		r.flights();
		break;
	}
